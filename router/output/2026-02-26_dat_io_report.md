...
| 4 | `# System configuration` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 6 | `clear configuration` | CDkRouter1200::WriteTftpFile | なし | CDkRouter(1200)::Analize | なし (スキップ等) | 初期化用固定コマンド |
| 7 | `no schedule at 1` | CDkRouter1200::WriteTftpFile | なし | CDkRouter(1200)::Analize | なし (スキップ等) | 初期化用固定コマンド |
| 8 | `no schedule at 2` | CDkRouter1200::WriteTftpFile | なし | CDkRouter(1200)::Analize | なし (スキップ等) | 初期化用固定コマンド |
| 9 | `no schedule at 3` | CDkRouter1200::WriteTftpFile | なし | CDkRouter(1200)::Analize | なし (スキップ等) | 初期化用固定コマンド |
| 10 | `no schedule at 4` | CDkRouter1200::WriteTftpFile | なし | CDkRouter(1200)::Analize | なし (スキップ等) | 初期化用固定コマンド |
...
| 14 | `security class 1 on on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 15 | `console info off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 17 | `ip routing process normal` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 18 | `ip route 10.142.65.0/24 gateway tunnel 2` | PutIpRoute | m_sRouter.sSIS05.no, m_sRouter.m_nIpTelNo 等 | ProcIP (ip route ...) | m_sRouter.sSIS05.no 等 (トンネル向け) | ルーティング設定 |
| 19 | `ip route 10.142.165.0/24 gateway tunnel 2` | PutIpRoute | m_sRouter.sSIS05.no, m_sRouter.m_nIpTelNo 等 | ProcIP (ip route ...) | m_sRouter.sSIS05.no 等 (トンネル向け) | ルーティング設定 |
| 20 | `ip route 10.145.0.0/16 gateway tunnel 2` | PutIpRoute | m_sRouter.sSIS05.no, m_sRouter.m_nIpTelNo 等 | ProcIP (ip route ...) | m_sRouter.sSIS05.no 等 (トンネル向け) | ルーティング設定 |
| 21 | `ip route 10.141.0.0/16 gateway tunnel 2` | PutIpRoute | m_sRouter.sSIS05.no, m_sRouter.m_nIpTelNo 等 | ProcIP (ip route ...) | m_sRouter.sSIS05.no 等 (トンネル向け) | ルーティング設定 |
| 23 | `ip route 172.18.0.0/16 gateway 172.16.5.11` | PutIpRoute | m_sRouter.con[n].ip, m_sRouter.sLAN3.ipGateWay 等 | ProcIP (ip route ...) | 各LAN・接続先向けIP | ルーティング設定 |
| 24 | `ip route 61.114.182.53 gateway pp 5 metric 2` | PutIpRoute | m_sRouter.m_nAdslNo, m_sRouter.m_nVWNo 等 | ProcIP (ip route ...) | m_sRouter.con[n].no 等 (PP向け) | ルーティング設定 |
| 25 | `ip route 61.114.182.54 gateway pp 5 metric 2` | PutIpRoute | m_sRouter.m_nAdslNo, m_sRouter.m_nVWNo 等 | ProcIP (ip route ...) | m_sRouter.con[n].no 等 (PP向け) | ルーティング設定 |
| 26 | `ip route 61.114.186.0/25 gateway pp 5 metric 2` | PutIpRoute | m_sRouter.m_nAdslNo, m_sRouter.m_nVWNo 等 | ProcIP (ip route ...) | m_sRouter.con[n].no 等 (PP向け) | ルーティング設定 |
| 27 | `ip route 61.114.177.148 gateway pp 5 metric 2` | PutIpRoute | m_sRouter.m_nAdslNo, m_sRouter.m_nVWNo 等 | ProcIP (ip route ...) | m_sRouter.con[n].no 等 (PP向け) | ルーティング設定 |
| 28 | `ip route 202.229.106.177 gateway pp 5 metric 2` | PutIpRoute | m_sRouter.m_nAdslNo, m_sRouter.m_nVWNo 等 | ProcIP (ip route ...) | m_sRouter.con[n].no 等 (PP向け) | ルーティング設定 |
| 29 | `ip route 172.31.191.0/24 gateway tunnel 1` | PutIpRoute | m_sRouter.sSIS05.no, m_sRouter.m_nIpTelNo 等 | ProcIP (ip route ...) | m_sRouter.sSIS05.no 等 (トンネル向け) | ルーティング設定 |
| 30 | `ip route 61.114.186.111 gateway pp 5` | PutIpRoute | m_sRouter.m_nAdslNo, m_sRouter.m_nVWNo 等 | ProcIP (ip route ...) | m_sRouter.con[n].no 等 (PP向け) | ルーティング設定 |
| 31 | `ip route 172.31.65.0/24 gateway tunnel 1` | PutIpRoute | m_sRouter.sSIS05.no, m_sRouter.m_nIpTelNo 等 | ProcIP (ip route ...) | m_sRouter.sSIS05.no 等 (トンネル向け) | ルーティング設定 |
| 32 | `ip route 52.197.151.142 gateway pp 5` | PutIpRoute | m_sRouter.m_nAdslNo, m_sRouter.m_nVWNo 等 | ProcIP (ip route ...) | m_sRouter.con[n].no 等 (PP向け) | ルーティング設定 |
| 33 | `ip route 0.0.0.0/32 gateway tunnel 3` | PutIpRoute | m_sRouter.sSIS05.no, m_sRouter.m_nIpTelNo 等 | ProcIP (ip route ...) | m_sRouter.sSIS05.no 等 (トンネル向け) | ルーティング設定 |
| 34 | `ip route 61.114.186.110 gateway pp 5` | PutIpRoute | m_sRouter.m_nAdslNo, m_sRouter.m_nVWNo 等 | ProcIP (ip route ...) | m_sRouter.con[n].no 等 (PP向け) | ルーティング設定 |
| 35 | `ip route 153.142.244.126 gateway pp 5` | PutIpRoute | m_sRouter.m_nAdslNo, m_sRouter.m_nVWNo 等 | ProcIP (ip route ...) | m_sRouter.con[n].no 等 (PP向け) | ルーティング設定 |
| 36 | `ip route 10.2.0.0/16 gateway tunnel 6` | PutIpRoute | m_sRouter.sSIS05.no, m_sRouter.m_nIpTelNo 等 | ProcIP (ip route ...) | m_sRouter.sSIS05.no 等 (トンネル向け) | ルーティング設定 |
| 37 | `ip route 153.142.244.125 gateway pp 5` | PutIpRoute | m_sRouter.m_nAdslNo, m_sRouter.m_nVWNo 等 | ProcIP (ip route ...) | m_sRouter.con[n].no 等 (PP向け) | ルーティング設定 |
| 38 | `ip route 10.1.0.0/16 gateway tunnel 7` | PutIpRoute | m_sRouter.sSIS05.no, m_sRouter.m_nIpTelNo 等 | ProcIP (ip route ...) | m_sRouter.sSIS05.no 等 (トンネル向け) | ルーティング設定 |
| 39 | `ip route default gateway pp 5 metric 2` | PutIpRoute | m_sRouter.m_nAdslNo, m_sRouter.m_nVWNo 等 | ProcIP (ip route ...) | m_sRouter.con[n].no 等 (PP向け) | ルーティング設定 |
| 40 | `ip route 10.0.192.0/24 gateway pp anonymous metric 2` | PutIpRoute | m_sRouter.ip | ProcIP (ip route ...) | m_sRouter.ip など関連変数 | ルーティング設定 |
| 41 | `ip route 10.0.208.0/24 gateway tunnel 5` | PutIpRoute | m_sRouter.sSIS05.no, m_sRouter.m_nIpTelNo 等 | ProcIP (ip route ...) | m_sRouter.sSIS05.no 等 (トンネル向け) | ルーティング設定 |
| 42 | `ip route 10.0.224.0/24 gateway tunnel 5` | PutIpRoute | m_sRouter.sSIS05.no, m_sRouter.m_nIpTelNo 等 | ProcIP (ip route ...) | m_sRouter.sSIS05.no 等 (トンネル向け) | ルーティング設定 |
| 43 | `ip icmp parameter-problem send off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 44 | `ip icmp echo-reply send-only-linkup on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 46 | `# LAN/IP configuration` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 49 | `rip use on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 50 | `ip lan1 rip send on version 2` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 51 | `ip lan1 rip receive on version 2` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 52 | `ip lan1 proxyarp on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 53 | `ip lan1 secure filter name dk_lan1` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 54 | `ip lan1 intrusion detection in on reject=on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 55 | `ip lan2 rip send off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 56 | `ip lan2 rip receive off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 57 | `ip lan2 proxyarp off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 58 | `ip lan2 intrusion detection in on reject=on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 60 | `# PP configuration` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 62 | `pp disable all` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 64 | `### PP 5 ###` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 66 | `pp select 5` | PutPp | m_sRouter.con[n].no または anonymous | ProcPP (pp select ...) | m_nCurrentPP など現在の接続対象状態変数 | PP選択 |
| 67 | `pp backup none` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 68 | `pppoe use lan2` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 69 | `pppoe auto connect on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 70 | `pppoe auto disconnect on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 71 | `pppoe disconnect time off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 72 | `ip pp mtu 1454` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 73 | `ip pp intrusion detection in on reject=on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 74 | `ip pp nat descriptor 2000` | PutPp | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 75 | `pp auth accept pap chap` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 76 | `pp always-on on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 77 | `ip pp secure filter name dk_pp_lan2` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 78 | `ip pp address 153.142.244.124/32` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 80 | `ppp lcp mru on 1454` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 81 | `ppp ccp type none` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 82 | `ip pp rip send off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 83 | `ip pp rip receive off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 84 | `pp enable 5` | PutTunnel / PutPp | m_sRouter.con[n].no 等の番号 | ProcTunnel / ProcPP | m_sRouter.con[n].type 有効化フラグ等 | 定義有効化 |
| 86 | `### PP anonymous ###` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 88 | `no ip route 10.0.192.0/20` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 89 | `pp select anonymous` | PutPp | m_sRouter.con[n].no または anonymous | ProcPP (pp select ...) | m_nCurrentPP など現在の接続対象状態変数 | PP選択 |
| 90 | `no ip pp rip send` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 91 | `no ip pp rip receive` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 92 | `no ip pp nat descriptor` | CDkRouter1200::WriteTftpFile | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 93 | `no pp auth username ccsupport` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 94 | `pp bind tunnel16-tunnel20` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 95 | `pp auth request mschap-v2` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 96 | `pp auth username w8LeUYeGaZgstZXs 00393792` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 97 | `ppp ipcp ipaddress on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 98 | `ppp ipcp msext on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 100 | `ip pp mtu 1258` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 101 | `pp enable anonymous` | PutTunnel / PutPp | m_sRouter.con[n].no 等の番号 | ProcTunnel / ProcPP | m_sRouter.con[n].type 有効化フラグ等 | 定義有効化 |
| 102 | `tunnel disable all` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 104 | `### TUNNEL 1 ###` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 107 | `tunnel encapsulation ipsec` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 108 | `ipsec tunnel 101` | PutTunnel | 設定先のnSetuzokuNo | ProcIPSEC (ipsec tunnel ...) | m_sRouter.con[n].type等への紐付け | IPSec Tunnel宣言 |
| 109 | `ipsec sa policy 101 1 esp 3des-cbc sha-hmac` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 119 | `tunnel backup tunnel 4 switch-interface=on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 120 | `ip tunnel rip send off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 121 | `ip tunnel rip receive off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 122 | `ip tunnel nat descriptor 2012` | PutTunnel | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 123 | `tunnel enable 1` | PutTunnel / PutPp | m_sRouter.con[n].no 等の番号 | ProcTunnel / ProcPP | m_sRouter.con[n].type 有効化フラグ等 | 定義有効化 |
| 125 | `### TUNNEL 3 ###` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 141 | `ipsec sa policy 103 3 esp aes-cbc sha-hmac` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 142 | `tunnel backup none` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 143 | `ip tunnel rip send off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 144 | `ip tunnel rip receive off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 145 | `ip tunnel nat descriptor 1` | PutTunnel | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 146 | `tunnel enable 3` | PutTunnel / PutPp | m_sRouter.con[n].no 等の番号 | ProcTunnel / ProcPP | m_sRouter.con[n].type 有効化フラグ等 | 定義有効化 |
| 148 | `### TUNNEL 6 ###` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 164 | `ipsec sa policy 106 6 esp aes-cbc sha-hmac` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 165 | `tunnel backup none` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 166 | `ip tunnel rip send off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 167 | `ip tunnel rip receive off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 168 | `ip tunnel nat descriptor 1` | PutTunnel | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 169 | `tunnel enable 6` | PutTunnel / PutPp | m_sRouter.con[n].no 等の番号 | ProcTunnel / ProcPP | m_sRouter.con[n].type 有効化フラグ等 | 定義有効化 |
| 171 | `### TUNNEL 7 ###` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 187 | `ipsec sa policy 107 7 esp aes-cbc sha-hmac` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 188 | `tunnel backup none` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 189 | `ip tunnel rip send off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 190 | `ip tunnel rip receive off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 191 | `ip tunnel nat descriptor 1` | PutTunnel | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 192 | `tunnel enable 7` | PutTunnel / PutPp | m_sRouter.con[n].no 等の番号 | ProcTunnel / ProcPP | m_sRouter.con[n].type 有効化フラグ等 | 定義有効化 |
| 194 | `### TUNNEL 5 ###` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 197 | `tunnel encapsulation ipsec` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 198 | `ipsec tunnel 105` | PutTunnel | 設定先のnSetuzokuNo | ProcIPSEC (ipsec tunnel ...) | m_sRouter.con[n].type等への紐付け | IPSec Tunnel宣言 |
| 199 | `ipsec sa policy 105 5 esp aes-cbc sha-hmac` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 210 | `ip tunnel rip send off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 211 | `ip tunnel rip receive off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 212 | `tunnel enable 5` | PutTunnel / PutPp | m_sRouter.con[n].no 等の番号 | ProcTunnel / ProcPP | m_sRouter.con[n].type 有効化フラグ等 | 定義有効化 |
| 214 | `### TUNNEL 4 ###` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 217 | `tunnel encapsulation ipsec` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 218 | `ipsec tunnel 104` | PutTunnel | 設定先のnSetuzokuNo | ProcIPSEC (ipsec tunnel ...) | m_sRouter.con[n].type等への紐付け | IPSec Tunnel宣言 |
| 219 | `ipsec sa policy 104 4 esp 3des-cbc sha-hmac` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 229 | `ip tunnel rip send off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 230 | `ip tunnel rip receive off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 231 | `ip tunnel nat descriptor 2012` | PutTunnel | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
...
| 234 | `tunnel encapsulation l2tp` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 235 | `ipsec tunnel 116` | PutTunnel | 設定先のnSetuzokuNo | ProcIPSEC (ipsec tunnel ...) | m_sRouter.con[n].type等への紐付け | IPSec Tunnel宣言 |
| 236 | `ipsec sa policy 116 16 esp aes-cbc sha-hmac` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 241 | `l2tp tunnel auth off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 242 | `l2tp tunnel disconnect time off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 243 | `l2tp keepalive use on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 244 | `ip tunnel tcp mss limit auto` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 245 | `ip tunnel secure filter name xai_tunnel_lan2` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 248 | `tunnel encapsulation l2tp` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 249 | `ipsec tunnel 117` | PutTunnel | 設定先のnSetuzokuNo | ProcIPSEC (ipsec tunnel ...) | m_sRouter.con[n].type等への紐付け | IPSec Tunnel宣言 |
| 250 | `ipsec sa policy 117 17 esp aes-cbc sha-hmac` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 255 | `l2tp tunnel auth off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 256 | `l2tp tunnel disconnect time off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 257 | `l2tp keepalive use on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 258 | `ip tunnel tcp mss limit auto` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 259 | `ip tunnel secure filter name xai_tunnel_lan2` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 262 | `tunnel encapsulation l2tp` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 263 | `ipsec tunnel 118` | PutTunnel | 設定先のnSetuzokuNo | ProcIPSEC (ipsec tunnel ...) | m_sRouter.con[n].type等への紐付け | IPSec Tunnel宣言 |
| 264 | `ipsec sa policy 118 18 esp aes-cbc sha-hmac` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 269 | `l2tp tunnel auth off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 270 | `l2tp tunnel disconnect time off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 271 | `l2tp keepalive use on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 272 | `ip tunnel tcp mss limit auto` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 273 | `ip tunnel secure filter name xai_tunnel_lan2` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 276 | `tunnel encapsulation l2tp` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 277 | `ipsec tunnel 119` | PutTunnel | 設定先のnSetuzokuNo | ProcIPSEC (ipsec tunnel ...) | m_sRouter.con[n].type等への紐付け | IPSec Tunnel宣言 |
| 278 | `ipsec sa policy 119 19 esp aes-cbc sha-hmac` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 283 | `l2tp tunnel auth off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 284 | `l2tp tunnel disconnect time off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 285 | `l2tp keepalive use on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 286 | `ip tunnel tcp mss limit auto` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 287 | `ip tunnel secure filter name xai_tunnel_lan2` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 290 | `tunnel encapsulation l2tp` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 291 | `ipsec tunnel 120` | PutTunnel | 設定先のnSetuzokuNo | ProcIPSEC (ipsec tunnel ...) | m_sRouter.con[n].type等への紐付け | IPSec Tunnel宣言 |
| 292 | `ipsec sa policy 120 20 esp aes-cbc sha-hmac` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 297 | `l2tp tunnel auth off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 298 | `l2tp tunnel disconnect time off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 299 | `l2tp keepalive use on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 300 | `ip tunnel tcp mss limit auto` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 301 | `ip tunnel secure filter name xai_tunnel_lan2` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 302 | `tunnel enable 20` | PutTunnel / PutPp | m_sRouter.con[n].no 等の番号 | ProcTunnel / ProcPP | m_sRouter.con[n].type 有効化フラグ等 | 定義有効化 |
| 304 | `### IPSEC ###` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 306 | `ipsec transport 16 116 udp 1701` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 307 | `ipsec transport 17 117 udp 1701` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 308 | `ipsec transport 18 118 udp 1701` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 309 | `ipsec transport 19 119 udp 1701` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 310 | `ipsec transport 20 120 udp 1701` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 312 | `# IP filter configuration` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 317 | `tunnel encapsulation ipsec` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 318 | `ipsec tunnel 102` | PutTunnel | 設定先のnSetuzokuNo | ProcIPSEC (ipsec tunnel ...) | m_sRouter.con[n].type等への紐付け | IPSec Tunnel宣言 |
| 319 | `ipsec sa policy 102 2 esp 3des-cbc sha-hmac` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 329 | `tunnel backup tunnel 8 switch-interface=on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 330 | `ip tunnel nat descriptor 2012` | PutTunnel | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 331 | `ip tunnel rip send off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 332 | `ip tunnel rip receive off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 335 | `tunnel encapsulation ipsec` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 336 | `ipsec tunnel 108` | PutTunnel | 設定先のnSetuzokuNo | ProcIPSEC (ipsec tunnel ...) | m_sRouter.con[n].type等への紐付け | IPSec Tunnel宣言 |
| 337 | `ipsec sa policy 108 8 esp 3des-cbc sha-hmac` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 347 | `ip tunnel nat descriptor 2012` | PutTunnel | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 348 | `ip tunnel rip send off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 349 | `ip tunnel rip receive off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
...
| 702 | `# NAT Descriptor configuration` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 704 | `nat descriptor log on` | CDkRouter1200::PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 705 | `nat descriptor masquerade ttl hold all` | CDkRouter1200::PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 706 | `nat descriptor type 1 nat` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 707 | `nat descriptor address outer 1 10.6.5.1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | m_sRouter.uip または m_sRouter.sLAN3.ip 等 | ProcNAT (nat descriptor ...) | m_sRouter.uip 等 (外側アドレス定義) | NAT設定 |
| 708 | `nat descriptor address inner 1 172.16.5.1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | m_sRouter.ip または m_sRouter.sLAN3.ipVirus 等 | ProcNAT (nat descriptor ...) | m_sRouter.ip 等 (内側アドレス定義) | NAT設定 |
| 709 | `nat descriptor static 1 1 10.6.1.1=172.16.1.1 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 710 | `nat descriptor static 1 2 10.6.2.1=172.16.2.1 2` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 711 | `nat descriptor static 1 4 10.6.4.1=172.16.4.1 8` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 712 | `nat descriptor static 1 5 10.6.5.1=172.16.5.1 10` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 713 | `nat descriptor static 1 10 10.6.10.1=172.16.10.1 2` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 714 | `nat descriptor static 1 11 10.6.11.1=172.16.11.1 128` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 715 | `nat descriptor static 1 12 10.6.12.1=172.16.12.1 128` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 716 | `nat descriptor static 1 13 10.6.13.1=172.16.13.1 8` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 717 | `nat descriptor static 1 14 10.6.14.1=172.16.14.1 12` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 718 | `nat descriptor static 1 15 10.6.15.1=172.16.15.1 8` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 719 | `nat descriptor static 1 20 10.6.20.1=172.16.20.1 2` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 720 | `nat descriptor static 1 21 10.6.21.1=172.16.21.1 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 721 | `nat descriptor static 1 30 10.6.30.1=172.16.30.1 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 722 | `nat descriptor static 1 31 10.6.31.1=172.16.31.1 8` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 723 | `nat descriptor static 1 40 10.6.40.1=172.16.40.1 32` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 724 | `nat descriptor static 1 50 10.6.50.1=172.16.50.1 3` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 725 | `nat descriptor static 1 52 10.6.52.1=172.16.52.1 8` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 726 | `nat descriptor static 1 60 10.6.60.1=172.16.60.1 127` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 727 | `nat descriptor static 1 121 10.6.121.20=172.16.121.20 40` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 728 | `nat descriptor static 1 80 10.6.80.1=172.16.80.1 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 729 | `nat descriptor static 1 81 10.6.81.1=172.16.81.1 16` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 730 | `nat descriptor static 1 82 10.6.82.1=172.16.82.1 16` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 731 | `nat descriptor static 1 83 10.6.83.1=172.16.83.1 16` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 732 | `nat descriptor static 1 110 10.6.110.1=172.16.110.1 2` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 733 | `nat descriptor static 1 100 10.6.100.1=172.16.100.1 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 734 | `nat descriptor static 1 122 10.6.122.1=172.16.122.1 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 735 | `nat descriptor type 2000 masquerade` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 736 | `nat descriptor address outer 2000 153.142.244.124` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | m_sRouter.uip または m_sRouter.sLAN3.ip 等 | ProcNAT (nat descriptor ...) | m_sRouter.uip 等 (外側アドレス定義) | NAT設定 |
| 737 | `nat descriptor masquerade static 2000 1 172.16.5.1 udp 500` | CDkRouter1200::PutNatOther | m_sRouter.ip | ProcNAT (nat descriptor ...) | m_sRouter.ip 等 (プロトコル静的NAT定義) | NAT設定 |
| 738 | `nat descriptor masquerade static 2000 2 172.16.5.1 esp` | CDkRouter1200::PutNatOther | m_sRouter.ip | ProcNAT (nat descriptor ...) | m_sRouter.ip 等 (プロトコル静的NAT定義) | NAT設定 |
| 739 | `nat descriptor masquerade static 2000 6 172.16.5.1 udp 4500` | CDkRouter1200::PutNatOther | m_sRouter.ip | ProcNAT (nat descriptor ...) | m_sRouter.ip 等 (プロトコル静的NAT定義) | NAT設定 |
| 740 | `nat descriptor masquerade static 2000 7 172.16.5.1 tcp 53196` | CDkRouter1200::PutNatOther | m_sRouter.ip | ProcNAT (nat descriptor ...) | m_sRouter.ip 等 (プロトコル静的NAT定義) | NAT設定 |
| 741 | `nat descriptor type 2012 masquerade` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 742 | `nat descriptor address outer 2012 172.23.176.129` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | m_sRouter.uip または m_sRouter.sLAN3.ip 等 | ProcNAT (nat descriptor ...) | m_sRouter.uip 等 (外側アドレス定義) | NAT設定 |
| 743 | `nat descriptor address inner 2012 auto` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | m_sRouter.ip または m_sRouter.sLAN3.ipVirus 等 | ProcNAT (nat descriptor ...) | m_sRouter.ip 等 (内側アドレス定義) | NAT設定 |
| 744 | `nat descriptor static 2012 2 172.23.176.130=172.16.5.1 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 745 | `nat descriptor static 2012 3 172.23.176.131=172.16.60.1 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 746 | `nat descriptor static 2012 4 172.23.176.132=172.16.1.1 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 747 | `nat descriptor static 2012 5 172.23.176.133=172.16.21.1 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 748 | `nat descriptor static 2012 6 172.23.176.134=172.16.80.1 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 749 | `nat descriptor static 2012 7 172.23.176.135=172.16.15.1 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 750 | `nat descriptor static 2012 8 172.23.176.136=172.16.52.8 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 751 | `nat descriptor static 2012 9 172.23.176.137=172.16.50.2 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 752 | `nat descriptor static 2012 10 172.23.176.138=172.16.20.1 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 753 | `nat descriptor static 2012 11 172.23.176.139=172.16.20.2 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 754 | `nat descriptor static 2012 12 172.23.176.140=172.16.110.1 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 755 | `nat descriptor static 2012 13 172.23.176.141=172.16.110.2 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 756 | `nat descriptor static 2012 14 172.23.176.142=172.16.122.1 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 757 | `nat descriptor static 2012 15 172.23.176.143=172.16.15.100 1` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 758 | `nat descriptor type 12 masquerade` | CDkRouter1200::PutNat_C / PutNat_R / PutNat_H / PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 759 | `nat descriptor masquerade static 2000 3 172.16.5.1 tcp 1723` | CDkRouter1200::PutNatOther | m_sRouter.ip | ProcNAT (nat descriptor ...) | m_sRouter.ip 等 (プロトコル静的NAT定義) | NAT設定 |
| 760 | `nat descriptor masquerade static 2000 4 172.16.5.1 gre` | CDkRouter1200::PutNatOther | m_sRouter.ip | ProcNAT (nat descriptor ...) | m_sRouter.ip 等 (プロトコル静的NAT定義) | NAT設定 |
| 761 | `nat descriptor masquerade static 2000 5 172.16.5.1 udp 4500` | CDkRouter1200::PutNatOther | m_sRouter.ip | ProcNAT (nat descriptor ...) | m_sRouter.ip 等 (プロトコル静的NAT定義) | NAT設定 |
| 762 | `nat descriptor sip 2000 off` | CDkRouter1200::PutNatOther | NAT変換関連IP (m_sRouter.ip等) | ProcNAT (nat descriptor ...) | 各種NATポート・IP関連フラグ | NAT設定 |
| 764 | `# Other configuration` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 766 | `syslog info on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 767 | `syslog notice on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 768 | `syslog debug off` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 769 | `tftp host any` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 770 | `ipsec auto refresh on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 771 | `dhcp server rfc2131 compliant except remain-silent` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 772 | `dns server 211.129.14.134 211.129.12.43` | CDkRouter1200::WriteTftpFile | m_sRouter.con[n].ip, m_sRouter.con[n].mask / m_sRouter.sLAN3.sPriSecIp.ip 等 | ProcDNS | m_sRouter.con[n].ip 等 | DNS設定 |
| 773 | `dns server pp 5` | CDkRouter1200::WriteTftpFile | m_sRouter.m_nAdslNo, m_sRouter.m_nVWNo | ProcDNS | m_sRouter.m_nAdslNo 等 (PP番号) | DNS設定 |
| 774 | `dns private address spoof on` | CDkRouter1200::WriteTftpFile | なし (固定) | ProcDNS | なし | DNS設定 |
| 775 | `schedule at 1 */* 6:00 * ntpdate 172.31.191.62` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 776 | `dns service recursive` | CDkRouter1200::WriteTftpFile | なし (固定) | ProcDNS | なし | DNS設定 |
| 777 | `no dhcp service` | CDkRouter1200::WriteTftpFile | m_szFirstAdd, m_szLastAdd, m_sRouter.m_fDHCP | ProcDHCP | m_szFirstAdd, m_szLastAdd, m_sRouter.m_fDHCP 等 | DHCPスコープ/サービス設定 |
| 778 | `no dhcp scope 1` | CDkRouter1200::WriteTftpFile | m_szFirstAdd, m_szLastAdd, m_sRouter.m_fDHCP | ProcDHCP | m_szFirstAdd, m_szLastAdd, m_sRouter.m_fDHCP 等 | DHCPスコープ/サービス設定 |
| 779 | `dhcp scope option 1 dns=172.16.5.1` | CDkRouter1200::WriteTftpFile | m_sRouter.ip_2_cloud, m_sRouter.m_nFqdnState | ProcDHCP | m_sRouter.ip_2_cloud, m_sRouter.m_nFqdnState 等 | DHCPスコープ/サービス設定 |
| 780 | `pptp service on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 781 | `ip stealth pp 5` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 782 | `l2tp service on` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 783 | `schedule at 2 startup * lua /xai_check.lua` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 784 | `schedule at 3 */* 04:00:00 * terminate lua all` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 785 | `schedule at 4 */* 04:00:10 * lua /xai_check.lua` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 786 | `# LIFT_PHASE=1` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 787 | `description 1 "configversion=5.0"` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 788 | `save` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 789 | `description 1 "configversion=5.1"` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |
| 790 | `save` | CDkRouter1200::WriteTftpFile | なし (固定文字列が主) | 各要素のProc処理 または 読込スキップ | なし または 簡易フラグ | その他固定設定・コマンド |